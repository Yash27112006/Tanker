...
textSize(20);
text("Use the DOWN_ARROW to fire and the UP_ARROW to reload.",100,40);
text("Try to move all the bouncing balls out of the screen.",148,65);
text("!!!  ALL THE BEST  !!!",260,110);
